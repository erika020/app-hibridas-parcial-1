...
export default function AchievementForm({ initialData, onSubmit, submitLabel = "Save" }) {
  ...
  return (
    <form onSubmit={submit} className="form-card" style={{ display: "grid", gap: 12 }}>
      ...
      <label className="field">
        ...
        <input name="points" className="input" value={formData.points} onChange={handleChange} />
      </label>
